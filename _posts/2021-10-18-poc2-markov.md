...
[Previous post](/posts/2021/10/poc1-dags-d-sep/)
...
This means that when using joint distributions, we **lose expressive power**. Think about this in the following way: if we say "green" (joint) to both "smaragd green" $(G_1)$ and "moss green" $(G_2)$, then our expressive power is limited.
